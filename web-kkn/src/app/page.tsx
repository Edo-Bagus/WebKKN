    ...
    <div className="bg-accent min-h-screen text-primary">
      ...
      <main className="flex flex-col items-center justify-center text-center h-screen">
        <div className="flex flex-col items-center justify-center text-center bg-primary text-secondary rounded-2xl p-6 m-4 h-[90%] w-[95%] max-w-8xl">
          ...
          <p className="max-w-2xl text-base md:text-lg leading-relaxed">
            <span className="font-semibold">Langkara Talambo</span> adalah
            inisiatif mahasiswa Universitas Gadjah Mada yang hadir di Kecamatan
            Tegalombo, Pacitan. Melalui program{" "}
            <span className="italic">KKN PPM UGM 2025</span>, kami berkomitmen
            untuk mengangkat potensi budaya, memperkuat kolaborasi dengan
            masyarakat, dan merawat keindahan alam. Halaman ini menjadi ruang
            berbagi cerita, dokumentasi kegiatan, serta gagasan keberlanjutan
            dari desa{" "}
            <span className="font-semibold">Tahunan dan Tahunan Baru</span>.
          </p>
      ...
      <section className="relative flex flex-col md:flex-row items-center justify-between gap-12 px-4 md:px-16 lg:px-32 py-16 min-h-[80vh] overflow-hidden">
        <div className="flex-1 text-center md:text-left relative z-30">
          ...
          <p className="text-base md:text-lg leading-relaxed">
            Fokus utama kami mencakup dokumentasi budaya, pengembangan ekonomi
            lokal, hingga penguatan kapasitas masyarakat desa. Dengan pendekatan
            partisipatif, setiap program dirancang tidak hanya untuk memberikan
            solusi jangka pendek, tetapi juga mendorong keberlanjutan jangka
            panjang. Kami ingin Tegalombo dikenal tidak hanya karena keindahan
            alamnya, tetapi juga karena kekuatan masyarakatnya.
          </p>
        </div>
      ...
      <section className="px-8 md:px-24 py-16 overflow-hidden">
        ...
        <p className="max-w-3xl mx-auto text-center text-base md:text-lg mb-12">
          Di blog ini, tercatat kisah perjalanan tim, cerita inspiratif dari
          warga, serta dokumentasi kegiatan selama{" "}
          <span className="font-semibold">KKN PPM UGM 2025</span> di Tegalombo.
          Artikel-artikel ini ditulis untuk memberi wawasan lebih dalam mengenai
          budaya, sejarah, dan potensi alam yang kami eksplorasi bersama
          masyarakat.
        </p>
